    ...
    try {
      ...
      if (
        ...
        try {
          ...
          alert(
            "Storage quota exceeded. Other projects were removed to save this one. Consider exporting important projects as JSON.",
          );
        } catch {
          alert(
            "Storage quota exceeded. Please export your project as JSON and clear browser data.",
          );
        }
      } else {
        throw e;
