...
export const furnitureCatalog: FurnitureDef[] = [
  ...
  {
    id: "bush_large_triangle",
    name: "Large Triangle Bush",
    category: "Landscaping",
    icon: "🌿",
    color: "#166534",
    width: 120,
  ...
  {
    id: "grass_leafs_large",
    name: "Large Grass Leaves",
    category: "Landscaping",
    icon: "🌾",
    color: "#365314",
    width: 40,
...
export const furnitureCategories = [
  ...new Set(furnitureCatalog.map((f) => f.category)),
];
