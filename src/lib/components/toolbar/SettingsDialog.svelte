<script lang="ts">
    ...
    import { currentProject, updateProjectName } from "$lib/stores/layout";
    ...
    let activeTab = $state<"project" | "dimensions" | "appearance" | "ai">(
        "project",
    );
    let geminiKey = $state("");
...
{#if open}
    ...
    >
        <div
            class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[420px] max-h-[80vh] flex flex-col"
        ...
        >
            ...
            >
                ...
                >
                    Project
                    {#if activeTab === "project"}<div
                            class="absolute bottom-0 left-0 right-0 h-0.5 bg-slate-700 dark:bg-slate-300 rounded-t"
                        ></div>{/if}
                </button>
                <button
                    class="px-4 py-2 text-sm font-medium transition-colors relative {activeTab ===
            ...
            <div class="p-5 overflow-y-auto">
                ...
                {:else if activeTab === "dimensions"}
                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        >
                            <button
                                class="px-3 py-1.5 text-sm font-medium transition-colors {settings.units ===
                                'metric'
                    ...
                    <!-- Toggle options -->
                    <div
                        class="bg-gray-50 dark:bg-gray-700/50 rounded-xl divide-y divide-gray-200 dark:divide-gray-600"
                    >
                        <label
                  ...
                  before:content-[''] before:absolute before:w-4 before:h-4 before:rounded-full before:bg-white before:top-0.5 before:left-0.5 before:transition-transform checked:before:translate-x-5"
                        ...
                        >
                            ...
                            <div class="flex items-center gap-2">
                                <button
                                    class="w-8 h-8 rounded border-2 transition-colors {settings.dimensionLineColor ===
                                    '#ffffff'
                                        ? 'border-slate-600'
                                        : 'border-gray-200'}"
                ...
                {:else if activeTab === "appearance"}
                    <div class="space-y-4">
                        <div>
                            <span
                                class="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-3"
                                >Theme</span
                            >
                            <div class="flex gap-3">
                                {#each [["light", "☀️", "Light"], ["dark", "🌙", "Dark"], ["system", "💻", "System"]] as [value, icon, label]}
                                    <button
                                        class="flex-1 flex flex-col items-center gap-2 p-3 rounded-xl border-2 transition-all {currentTheme ===
                                        value
                ...
                {:else if activeTab === "ai"}
                    <div class="space-y-4">
                        <div>
                            ...
                            >
                                Required for AI-powered photorealistic
                                rendering. Your key is stored locally in your
                                browser only - never sent to our servers.
                            </p>
                            <div class="flex gap-2">
                                <div class="relative flex-1">
                                    <input
                                        type={geminiKeyVisible
                                            ? "text"
                                            : "password"}
                                        value={geminiKey}
                                        oninput={(e) => {
                        ...
                        >
                            <span
                                ...
                                >How to get a Gemini key</span
                            >
                            <ol
                                class="text-xs text-gray-500 dark:text-gray-400 space-y-1 list-decimal list-inside"
                            >
                                <li>
                                    Go to <a
                        ...
                        >
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mb-3"
                            >
                                Optional — enables OpenAI image generation as an
                                alternative to Gemini. Stored locally only.
                            </p>
                            <div class="flex gap-2">
                                <div class="relative flex-1">
                                    <input
                                        type={openaiKeyVisible
                                            ? "text"
                                            : "password"}
                                        value={openaiKey}
                                        oninput={(e) => {
