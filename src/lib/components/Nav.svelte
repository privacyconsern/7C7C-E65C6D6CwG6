...
<nav class="flex gap-4 justify-center px-24 py-12">
    <a href="/" class="text-4xl font-poppins-bold">
    ...
    <a
        href="/about"
        class="font-poppins-semi-bold ml-4 text-xl justify-between gap-4 relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-100 hover:after:w-full"
        >About</a
    >
