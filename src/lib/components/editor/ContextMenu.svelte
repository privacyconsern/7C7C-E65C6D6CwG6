    ...
    >
        {#if targetType === "furniture"}
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("rotate-furniture-90")}
            >
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("flip-horizontal")}
            >
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("bring-to-front")}
            >
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("send-to-back")}
            >
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("toggle-lock")}
            >
                <span class="ctx-icon"
                    >{targetFurniture?.locked ? "🔓" : "🔒"}</span
                >
                {targetFurniture?.locked ? "Unlock" : "Lock"}
            </button>
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("properties")}
            >
        ...
        {:else if targetType === "wall"}
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("toggle-curve")}
            >
                <span class="ctx-icon">〰️</span> Curve {targetWall?.curvePoint
                    ? "Off"
                    : "On"}
            </button>
            <div class="ctx-sep"></div>
        ...
        {:else if targetType === "room"}
            ...
            <button
                class="ctx-item"
                role="menuitem"
                onclick={() => clickItem("change-floor-texture")}
            >
