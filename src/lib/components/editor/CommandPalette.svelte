    ...
    const tools: ResultItem[] = [
        {
            ...
            category: "tool",
            categoryLabel: "🔧 Tool",
            action: () => selectedTool.set("select"),
        },
        {
            id: "t-wall",
            name: "Wall Tool",
        ...
        },
        {
            ...
            category: "tool",
            categoryLabel: "🔧 Tool",
            action: () => selectedTool.set("window"),
        },
        {
            id: "t-furniture",
            name: "Furniture Tool",
            ...
            category: "tool",
            categoryLabel: "🔧 Tool",
            action: () => selectedTool.set("furniture"),
        },
        {
            id: "t-text",
            name: "Text Tool",
    ...
    const actions: ResultItem[] = [
        ...
        },
        {
            ...
            action: () => {
                ...
                const p = get(currentProject);
                if (canvas && p) exportAsPNG(canvas, p);
            },
        },
        {
            id: "a-export-json",
...
{#if open}
    ...
    >
        ...
        >
            <!-- Search input -->
            <div
                class="flex items-center gap-2 px-4 py-3 border-b border-gray-200"
            >
                ...
                />
                <kbd
                    class="text-[10px] px-1.5 py-0.5 bg-gray-100 rounded border border-gray-200 text-gray-400"
                    >ESC</kbd
                >
            </div>
            ...
            <div class="max-h-[50vh] overflow-y-auto">
                ...
                {:else}
                    {#each results as item, i}
                        ...
                        >
                            <span
                                class="text-base w-6 text-center flex-shrink-0"
                                >{item.icon}</span
                            >
            ...
            <!-- Footer hint -->
            <div
                class="px-4 py-2 border-t border-gray-100 flex items-center gap-3 text-[10px] text-gray-400"
            >
                <span
                    ><kbd
                        class="px-1 py-0.5 bg-gray-100 rounded border border-gray-200"
                        >↑↓</kbd
                    > navigate</span
                >
                <span
